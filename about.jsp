			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ธีรณัฐ มหัทธโนบล" class="rounded-circle shadow" width="140" height="140" src="assets/img/thiranat.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>ธีรณัฐ มหัทธโนบล</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010001</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/likecyber" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @likecyber</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="อาสูรา สาเมาะ" class="rounded-circle shadow" width="140" height="140" src="assets/img/asura.jpg" />
						<h5 class="pt-4 mb-3">ผู้ช่วยพัฒนาระบบ</h5>
						<h2>อาสูรา สาเมาะ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010006</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/asura.classic.9" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @asura.classic.9</a></p>
					</div>
					<div class="col-lg-4 pb-4">
